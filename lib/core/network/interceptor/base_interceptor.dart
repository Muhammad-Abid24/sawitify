...
class BaseInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    // Tambahkan headers khusus YouTube Music
    if (options.baseUrl.contains('music.youtube.com')) {
      options.headers.addAll({
        ...
        'X-Youtube-Device': 'cbr=Chrome&cbrand=apple&cbrver=81.0.4044.129&ceng=WebKit&cengver=537.36&cos=Macintosh&cosver=10_15_4&cplatform=DESKTOP',
