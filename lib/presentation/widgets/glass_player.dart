...
class _GlassPlayerCardState extends State<GlassPlayerCard> {
  ...
  void initState() {
    ...
    _isShuffleEnabled =
        _playerService.player.shuffleModeEnabled;

    _loopMode =
        _playerService.player.loopMode;
  ...
  Future<void> _skipToPrevious() async {
    ...
    try {
      ...
      await _playerService.playTrack(
        prevTrack,
      );
                  ...
                  //----------------------------------
                    ...
                    child: LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final minRequiredWidth = 56 + idealControlSize + 56 + 32;

                        // Check if we have enough width for horizontal layout
                        final useHorizontalLayout = constraints.maxWidth >= minRequiredWidth;

                        // Determine actual control size
                        final controlSize = useHorizontalLayout
                            ? idealControlSize
                            : idealControlSize.clamp(0.0, constraints.maxWidth - 32);
                        ...
                        final shuffleRepeatRadius = ringSize * 0.78;
                          ...
                          children: [
                            ...
                            if (useHorizontalLayout)
                              ...
                              SizedBox(
                                ...
                                child: IconButton(
                                  ...
                                  icon: Icon(
                                    Icons.shuffle,
                                    color: _playerService.shuffleEnabled
                                        ? AppColors.primary
                                        : Colors.white,
                                    size: 30,
                                  ),
                            ...
                            SizedBox(
                              ...
                              child: IconButton(
                                ...
                                icon: Icon(
                                  _playerService.loopMode == LoopMode.one
                                      ? Icons.repeat_one
                                      : Icons.repeat,
                                  color: _playerService.loopMode != LoopMode.off
                                      ? AppColors.primary
                                      : Colors.white,
                                  size: 30,
                                ),
